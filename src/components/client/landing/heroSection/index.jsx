    ...
    <div className="container-fluid row px-2 pt-4 pb-4 m-0 heroSecDiv">
      ...
      <div className="col-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <p className="text-justify heroTextParagraph">
          ...
          Nisi diam vitae, cursus ac velit bibendum tristique. Vitae
          lacinia proin urna, in pretium dui. Suspendisse proin etiam
          senectus gravida suscipit.
        </p>
        <button className="btn" id="btnJonNow">Join Now</button>
      </div>
      <div
        className="col-12 col-sm-6 col-md-6 col-lg-6 heroImgSec d-flex justify-content-end align-items-center mt-4 mt-lg-0 mt-md-4 mt-sm-4">
