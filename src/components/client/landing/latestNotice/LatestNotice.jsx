...
import notice1 from './../../../../assets/images/notice/notice1.jpeg'
import notice2 from './../../../../assets/images/notice/notice2.png'
import notice3 from './../../../../assets/images/notice/notice3.png'
import notice4 from './../../../../assets/images/notice/notice4.png'
          ...
          <ul className='carousel__track'>
            {images.map((image, index) => (
              <li key={index} className='carousel_slide current-slide'>
                <img className='carousel-images' src={image} alt='notice' />
              </li>
            ))}
          </ul>
        </div>
