    ...
    <div className="container-fluid ps-4 pe-4">
      <div className="row">
        <div className="col-md-4">
          ...
          <div className="d-flex mb-4">
            ...
            <a href="https://www.facebook.com/">
              <FaFacebook
                className="me-2 text-white social-media-icon social-links"
                size="27"
              />
            </a>
        ...
        <div className="col-md-4 quick-link-area">
          ...
          <hr className="hr-line" />
          <p className="subscribe-p fw-normal">Dont forget to subscribe our news letters,enter your e-mail here.</p>
          <div className="input-group mb-3">
            <input type="text" className="form-control rounded" placeholder="Email Address" aria-label="Email
                   Address" aria-describedby="basic-addon2" id="subscribe-input" />
            <span className="input-group-text rounded" id="basic-addon2"><i className="fa fa-solid fa-envelope"
                                                                            id="emailIconInText"></i></span>
          </div>
        </div>
      </div>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <p className="text-center text-white">Copyright © 2023 - All Rights Reserved | Powered By
          <span className="ps-2"><img className="pw-img ms-1" src={msClubFooterLogo} alt="logo" /></span>
        </p>
      </div>
    </div>
  </section>)
